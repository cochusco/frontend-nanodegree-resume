...
var education = {
	"schools": [{
		...
		"location": "Madrid",
		"degree": "EGB",
		"majors": ["fisica", "biologia"],
		"dates": 1995,
		"url": "http://www.madrid.corazonistas.com/"
	}, {
		"name": "Ramiro de Maeztu",
		"location": "Madrid",
		"degree": "BUP",
		"majors": ["matematicas", "ingles"],
		"dates": 1997,
		"url": "http://www.educa.madrid.org/web/ies.ramirodemaeztu.madrid"
	}],
	"onlineCourses": [{
	...
	"display": function() {
		...
		for (var onlineCourse in education.onlineCourses) {
			$("#education").append(HTMLschoolStart);
			var educationOnlineEntry = HTMLonlineTitle.replace("%data%", education.onlineCourses[onlineCourse].title) + HTMLonlineSchool.replace("%data%", education.onlineCourses[onlineCourse].school) + HTMLonlineDates.replace("%data%", education.onlineCourses[onlineCourse].date) + HTMLonlineURL.replace("#", education.onlineCourses[onlineCourse].url).replace("%data%", education.onlineCourses[onlineCourse].url);
...
// returns an array with all location found in jobs.
...
// Log click location information.
